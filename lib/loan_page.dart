...
class LoanPage extends StatelessWidget {
  ...
  const LoanPage({super.key, required this.userData});
  ...
  // 🔍 ROBUST KEY FINDER FOR LOAN AMOUNT
  ...
  Widget build(BuildContext context) {
    final double generalLoan = _getLoanValue('GeneralLoan');
    final String userName = _getUserName();

    return Scaffold(
      backgroundColor: kBackgroundWarm,
      appBar: AppBar(
        title: const Text("सर्वसाधारण कर्ज"),
