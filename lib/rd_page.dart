...
class RDPage extends StatelessWidget {
  ...
  const RDPage({super.key, required this.userData});
  ...
  // 🔍 ROBUST KEY FINDER FOR RECURRING DEPOSIT
  double _getRDValue(String key) {
  ...
  Widget build(BuildContext context) {
    final double recurringDeposit = _getRDValue('RecurringDeposit');
    final String userName = _getUserName();

    return Scaffold(
      backgroundColor: kBackgroundWarm,
      appBar: AppBar(
        title: const Text("आवर्त ठेव"),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "₹ ${recurringDeposit.toStringAsFixed(2)}",
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        fontSize: 34,
