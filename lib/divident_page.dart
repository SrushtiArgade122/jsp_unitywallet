...
class DividendPage extends StatelessWidget {
  ...
  const DividendPage({super.key, required this.userData});
  ...
  // 🔍 ROBUST KEY FINDER FOR DIVIDEND
  double _getDividendValue(String key) {
    ...
    for (String k in keysToCheck) {
      if (userData.containsKey(k)) {
        double dividend = numVal(userData[k]);
  ...
  Widget build(BuildContext context) {
    final double dividend = _getDividendValue('Dividend');
    final String userName = _getUserName();

    return Scaffold(
      backgroundColor: kBackgroundWarm,
      appBar: AppBar(
        title: const Text("लाभांश"),
